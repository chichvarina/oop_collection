...
public class PassengerCar extends Car implements Competable {
    ...
    private ArrayList<Mechanic<PassengerCar>> mechanics;

    public PassengerCar(String brand, String model, float engineVolume, Body body,
                        Driver<PassengerCar> driver, ArrayList<Sponsor> sponsors, ArrayList<Mechanic<PassengerCar>> mechanics) {
    ...
    public ArrayList<Mechanic<PassengerCar>> getMechanics() {
        return mechanics;
    }
}
