...
public class Truck extends Car implements Competable{
    ...
    private ArrayList<Mechanic<Truck>> mechanics;

    public Truck(String brand, String model, float engineVolume, float mass,
                 Driver<Truck> driver, ArrayList<Sponsor> sponsors, ArrayList<Mechanic<Truck>> mechanics) {
    ...
    public ArrayList<Mechanic<Truck>> getMechanics() {
        return mechanics;
    }
}
