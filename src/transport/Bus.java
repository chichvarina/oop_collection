...
public class Bus extends Car implements Competable{
    ...
    private ArrayList<Mechanic<Bus>> mechanics;

    public Bus(String brand, String model, float engineVolume, int seatsNumber,
               Driver<Bus> driver, ArrayList<Sponsor> sponsors, ArrayList<Mechanic<Bus>> mechanics) {
    ...
    public ArrayList<Mechanic<Bus>> getMechanics() {
        return mechanics;
    }
}
